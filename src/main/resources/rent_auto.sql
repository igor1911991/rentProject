...
DROP TABLE IF EXISTS drivers_licence;
...
(
	...
	date_of_birth date not null,
	drivers_license char(17),
	PRIMARY KEY(client_id),
	FOREIGN KEY(drivers_license) REFERENCES drivers_licence(drivers_licence_id) ON DELETE RESTRICT
);
